...
*---<< S/4HANA >>---*
*--------------------------------------------------------------------*
* Changed On - Friday, October 12, 2018 13:35:00
...
PARAMETERS     : p_grat(3) TYPE n OBLIGATORY.
...
DATA : it_pa0185 TYPE STANDARD TABLE OF pa0185,
      wa_pa0185 TYPE pa0185.
*&---------------------------------------------------------------------*
*&                      FIELD SYMBOLS
*&---------------------------------------------------------------------*
...
FORM get_data .
  ...
  SELECT * FROM pa0185 INTO TABLE it_pa0185
...
*      at end of paydt.
    ...
    IF fl_flag = 1.
      ...
      READ TABLE it_pa0185 INTO wa_pa0185 WITH KEY pernr = itab1-pernr.
      IF sy-subrc = 0.
        stru-icnum = wa_pa0185-icnum.
      ENDIF.
...
FORM build_comment USING p_heading TYPE slis_t_listheader.
  ...
  line-info = 'REPORT : Gratuity Register' .
  line-typ = 'S' .
  APPEND line TO gt_list_top_of_page .
...
FORM f_fill_fieldcat_struct_dyn .
  ...
  it_field_dynamic-fieldname = 'ICNUM'.
  it_field_dynamic-desc      = 'Gratuity Number'.
  it_field_dynamic-reftab   = 'PA0185'.
...
*         WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4.
  ...
  COLLECT it_field_dynamic.
*
  CONCATENATE 'Gratuity@' p_grat INTO v_text.
...
FORM f_field_cat_for_dyn_table .
  LOOP AT it_field_dynamic.
    IF it_field_dynamic-fieldname EQ 'PERNR'
           ...
           OR it_field_dynamic-fieldname EQ 'ICNUM'.
