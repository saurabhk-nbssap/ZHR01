...
REPORT  z6hr008r_bonus_register_nu.
...
*  Check if basic is greater than 10000
          IF rt1-lgart EQ '1001' . " Basic
            lv_value = rt1-betrg.  " Get basic value variable
           IF rt1-betrg > 10000.
                    CONTINUE.
           ENDIF.
          ENDIF.
          IF rt1-lgart EQ '5000'.
            IF lv_value > 10000.
              CLEAR lv_value.
                    CONTINUE.
            ENDIF.
