...
*            wa_final-bonus = wa_retro-betrg.
          WHEN '2009'."OTHER EARNINGS chng by kashid "'1319'. " Gratuity
          ...
          WHEN '1315'. " Leave EN
            WA_FINAL-LV_ENC = WA_RETRO-BETRG.
          WHEN '1MVT'. " TDS
...
*  Net Payable
        WA_FINAL-NET_TOT = WA_FINAL-TOTAL - WA_FINAL-DEDCT.
...
FORM BUILD_COMMENT  USING    P_P_HEADING TYPE SLIS_T_LISTHEADER.
  ...
  LV_1 = 'Apr-04'.
  LV_2 = S_FAPER-LOW+0(2).
  CLEAR WA_MONTH_NAMES.
  READ TABLE IT_MONTH_NAMES INTO WA_MONTH_NAMES WITH KEY MNR = LV_2.
  WA_MONTH_NAMES-LTX = WA_MONTH_NAMES-LTX+0(3).

  CONCATENATE WA_MONTH_NAMES-LTX '-' LV_2 INTO LV_2.
